...
# The file Dataset.zip has been unzipped
# And we have set the working directory to /UCI HAR Dataset/
# where this file is stored
# this simplifies the code and does not forces us to download the file every time
